...
void GENERAL_TIMx_Init(void)
{
  ...
  htimx.Instance = GENERAL_TIMx;			// timer2
  htimx.Init.Prescaler = GENERAL_TIM_PRESCALER;		// 0x0000~0xffff, (HAL_RCC_GetSysClockFreq()/1000000*10 - 1)
  htimx.Init.CounterMode = TIM_COUNTERMODE_UP;
  htimx.Init.Period = GENERAL_TIM_PERIOD;				// 0x0000~0xffff, 50000
